...
\begin{lstlisting}
    ...
    initialise_block = "initialise", "(", {switch_initialisation | clock_initialisation}, ")", ";";

    connections_block = "connections", "(", {device_name, "(", {connection_definition}, ")", ";"}, ")", ";";
    ...
    gate_inputs = device_name, {[",", device_name]}, possession, {digit}, ("input" | "inputs"), ";";

    switch_initialisation = switch_name, {[",", switch_name]}, definition, switch_level, ";";
    
    clock_period = clock_name, ("cycle length" | "cycle"), {digit}, ";";

    connection_definition = (device_name | dtype_output_name | switch_name | clock_name), ("is connected to" | "to"), {(gate_input_name | dtype_input_name)}, ";";
