...
\begin{Verbatim}
    ...
    clock_period = clock_name, "cycle length", {digit}, semicolon;

    connection_definition = (device_name | dtype_output_name | switch_name | clock_name), ("is connected to" | "to" | "connects to" | arrow), 
    {(gate_input_name | dtype_input_name)}, semicolon;
