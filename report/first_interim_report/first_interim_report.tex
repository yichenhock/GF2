...
letter = "a" | "b" | "c" | "d" | "e" | "f" | "g" | "h" | "i" |
    ...
    device_definition = {device_name,[comma]}, definition, devices_type, semicolon;

    switch_definition = {switch_name,[comma]}, definition, ("SWITCHES" | "SWITCH"), semicolon;

    clock_definition = {clock_name,[comma]}, definition, ("CLOCK" |"CLOCKS"), semicolon;

    switch_initialisation = {switch_name,[comma]}, definition, switch_level, semicolon;

    inputs = {device_name,[comma] | switch_name,[comma]}, possession, {digit}, "inputs", semicolon;

    clock_frequency = clock_name, "frequency", {digit}, order_factor, semicolon;

    connection_definition = (device_name | switch_name), ["BAR"], ("is connected to" | "to" | "connects to" | arrow), 
    {(device_name | switch_name), dot, port_name}, semicolon;

    device_block = "device", bracket_open, {device_definition | switch_definition | clock_definition}, bracket_close, semicolon;
    ...
    {connection_definition}, bracket_close}, bracket_close, semicolon;

    monitors_block = "monitors", bracket_open, {device_name | switch_name}, bracket_close, semicolon;
...
\vspace{-0.4cm}
\begin{figure}[H]
    \includegraphics[width = \textwidth]{Simple Circuit.png}
    \vspace{-1cm}
    \caption{XOR Gate}
...
\begin{Verbatim}[numbers=left,xleftmargin=5mm]
    ...
    connections(
        a(
            ...
            sw2 is connected to a.IN2;
        );
    
        b(  
            sw1 is connected to b.IN1;
            sw2 is connected to b.IN2;
        );
    
        c(  
            a is connected to c.IN1;
            b is connected to c.IN2;
        );
    );
...
\begin{Verbatim}[numbers=left,xleftmargin=5mm]
    ...
    connections(
        a(
            e is connected to a.IN1;
            e is connected to a.IN2;
        );
    
        b(  
            e is connected to b.IN1;
            clk1 is connected to b.IN2;
        );
    
        c(  
            clk1 is connected to c.IN1;
            a is connected to c.IN2;
        );
    
        d(
            b is connected to d.IN1;
            e is connected to d.IN2;
        );
    
        e(  
            d is connected to e.IN1;
            c is connected to e.IN2;
        );
    
        f(  
            fBAR is connected to f.DATA;
            d is connected to f.CLK;
            sw1 is connected to f.SET;
            sw2 is connected to f.RESET;
        );
    
        g(  
            d is connected to g.IN1;
            f is connected to g.IN2;
        );
    );
