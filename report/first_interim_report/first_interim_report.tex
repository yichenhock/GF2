...
Syntax errors involve errors which do not conform to the format specified by the EBNF grammar. This is caught by the scanner. 
...
Clock must have 1 output, 0 inputs & devices: clk1 has 1 input & Incorrect number of inputs specified for clock clk1. 1 specified, but allowed number is 0.\\ 
\hline
Switch must have 1 output, 0 inputs & connections: sw1 to a.I1, sw1 to b.I1 & Incorrect number of outputs specified for switch sw1. 2 specified, but allowed number is 1.\\ 
\hline
AND, NAND, and NOR must have 1 output, 1-16 inputs & devices: a is NOR, a has 17 inputs & Incorrect number of outputs specified for NOR gate a. 17 specified, but allowed range is 1-16.\\
\hline
...
\hline
Switch initial value is not defined in initialisation & devices: sw1, sw1 are SWITCHES & Please define switches sw1, sw2 initial values.\\
\hline
