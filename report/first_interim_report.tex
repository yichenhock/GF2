...
\begin{itemize}
    ...
    \item Define device connections 
    \item Specify output signal to monitor
\end{itemize}
...
"BAR" following a \verb+device_name+ or \verb+switch_name+ denotes the inverse of the output. We do not include comment syntax in EBNF as the scanner removes comments from input file. The syntax for comments will be: \verb+# ;+

where "\#" denotes the start of the comment section, and ";" denotes the end of the comment section. 
There will be no line comments as line breaks and spaces hold no significance.
